...
- (void)showFirstTableView:(UIButton *)btn{
    ...
    if (_delegate && [_delegate respondsToSelector:@selector(MenuClickButton:Index:menuTitle:)]) {
        [_delegate MenuClickButton:btn Index:btn.tag menuTitle:btn.titleLabel.text];
    }
